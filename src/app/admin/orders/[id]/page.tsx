            ...
            <div className="p-6 max-w-6xl mx-auto space-y-5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {/* Cliente */}
                        <section className="bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-5 space-y-4 animate-fade-in-up animate-delay-150">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Resumo Financeiro */}
                        <section className="bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-5 space-y-3 animate-fade-in-up animate-delay-100">
                        ...
                        {/* Logística */}
                        <section className="bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-5 space-y-3 animate-fade-in-up animate-delay-150">
                            <h2 className="text-xs font-bold text-zinc-500 uppercase tracking-wider pb-3 border-b border-zinc-800/80">
                                Logística e Prazos
                            </h2>
